...
public class GameController : MonoBehaviour
{
    ...
    //public const float RIGHT_BOUNDARY = 9.3775f;
    //public const float LEFT_BOUNDARY = -9.3775f;
    ...
    private void SetAttractModeState(bool gameObjectIsActive)
    {
        ...
        bottomWall.gameObject.SetActive(gameObjectIsActive);
    }
    ...
    {
        playerTurn = START_SCORE;
    }


    private void ResetPlayerLives()
    {
        playerLives = START_SCORE;
    }
